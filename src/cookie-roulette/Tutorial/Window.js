    ...
    <div className="tutorial-window">
      ...
      <section className="content-wrapper custom-scroll">
        <div className="content">
          ...
          <p>
            Здесь находятся разные элементы управления,
            кнопка возврата в печеньку, счетчик ваших печенек и поцелуев,
          ...
          <p>
            ...
            с которым вы сможете поцеловаться (т.е. обменяться знаками внимания), если захотите.
          </p>
          ...
          <p>
            ...
            вам будет предложено его подарить. Если вы согласились все увидят как вы подарили
          ...
          <p>
            ...
            вы можете легко сменить стол на другой нажав кнопку сверху в меню, и вы увидите этот вопрос.<br/>
            Решились? - Смело жмите да, игра подберет вам новый стол и новую компанию.
          </p>

          <p style={{fontSize: '120%', textAlign: 'center'}}>
            Знакомьтесь, общайтесь, развлекайтесь, дарите друг другу подарки - вперед, начните играть сейчас!
          </p>
        </div>
      </section>
      <footer>
