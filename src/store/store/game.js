...
class GameStore {
  ...
  get kissWindow() {
    return this._kissWindow;
  }
  get changeTableWindow() {
    return this._changeTableWindow;
  }
  get turnTooltip() {
    return this._turnTooltip;
  }
  get turnsRemain() {
    return this._turnsRemain;
  }
  get turnsBeforeChangeTable() {
    return this._turnsBeforeChangeTable;
  }
  get rotateCookie() {
  ...
  get previousTargetSelector() {
    return this._previousTargetSelector;
  }
  get targetPlayer() {
    return this._targetPlayer;
  }
  get targetKiss() {
    return this._targetKiss;
  }
  ...
  setTargetSelector(seat) {
    this._previousTargetSelector = this._targetSelector
  ...
  clickRotateCookie() {
    if (this.allowClickRotate) {
      this._store.socket.emit("player-rotated-roulette", {
  ...
  clickDecision(result, auto) {
    ...
    this._store.amplitude.trackKisses();
  ...
  clearGameState() {
    ...
    this._store.table.update(this._store.table.id, { male: 0, female: 0 }, [
      null,
      null,
      null,
      null,
